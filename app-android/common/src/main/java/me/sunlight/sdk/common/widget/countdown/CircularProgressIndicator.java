package me.sunlight.sdk.common.widget.countdown;
...
public class CircularProgressIndicator extends View {
    ...
    public CircularProgressIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CircularProgressIndicator, defStyleAttr, 0);

        //initialize the variables with values set from the xml layout, if any.
        progressStrokeColor = typedArray.getColor(R.styleable.CircularProgressIndicator_progressColor, progressStrokeColor);
        backgroundStrokeColor = typedArray.getColor(R.styleable.CircularProgressIndicator_backgroundColor, backgroundStrokeColor);
        strokeWidth = typedArray.getInt(R.styleable.CircularProgressIndicator_strokeWidth, strokeWidth);
        progress = typedArray.getInt(R.styleable.CircularProgressIndicator_progress, 0);
        maxProgress = typedArray.getInt(R.styleable.CircularProgressIndicator_maxProgress, 100);
        textSize = typedArray.getDimension(R.styleable.CircularProgressIndicator_textSize, 20);
        textColor = typedArray.getInt(R.styleable.CircularProgressIndicator_textColor, Color.BLACK);
