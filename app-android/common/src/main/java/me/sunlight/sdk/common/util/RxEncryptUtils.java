...
import static me.sunlight.sdk.common.util.RxDataUtils.bytes2HexString;
import static me.sunlight.sdk.common.util.RxDataUtils.hexString2Bytes;
...
public class RxEncryptUtils {
     ...
     * @return 16进制密文  小写
     */
    public static String encryptMD5ToLowCaseString(String data) {
