...
/**
 * //压缩后得到新的图片路径 BitmapUtils.compressImageUpload
 * // 上传成功后删除缓存文件 BitmapUtils.deleteCacheFile()
 *
 * @author 戈传光
 */
public class BitmapUtils {
    ...
    private static Bitmap compressImage(Bitmap image) {
        ...
        image.compress(Bitmap.CompressFormat.JPEG, 40, baos); //这里压缩至40%
        int options = 40;
    ...
    private static String saveMyBitmap(String filename, Bitmap bit) {
        ...
        try {
            ...
            bit.compress(Bitmap.CompressFormat.PNG, 40, fOut);  //质量压缩40%
            fOut.flush();
            fOut.close();
