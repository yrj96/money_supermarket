...
/**
 * @author sun 在系统的Toast基础上封装
 */

@SuppressLint("InflateParams")
public class GcgToast {
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(getContext(), message, getDrawable(getContext(), R.drawable.ic_toast_warning), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(getContext(), message, getDrawable(getContext(), R.drawable.ic_toast_sucess), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(getContext(), message, getDrawable(getContext(), R.drawable.ic_toast_sucess), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(getContext(), message, getDrawable(getContext(), R.drawable.ic_toast_error), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, getDrawable(context, R.drawable.ic_toast_warning), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, getDrawable(context, R.drawable.ic_toast_sucess), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, getDrawable(context, R.drawable.ic_toast_sucess), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, getDrawable(context, R.drawable.ic_toast_error), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
